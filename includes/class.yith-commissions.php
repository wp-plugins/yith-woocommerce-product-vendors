...
if ( ! class_exists( 'YITH_Commissions' ) ) {
    ...
    class YITH_Commissions {
        ...
        public function add_menu_item() {
            ...
            if( $vendor->is_super_user() || $vendor->is_valid() && $vendor->has_limited_access() && $vendor->is_owner() ) {
        ...
        public function get_commissions( $q = array() ) {
            ...
            $res = $wpdb->get_col( "SELECT $found_rows DISTINCT c.ID FROM $wpdb->commissions c $join WHERE 1=1 $where $groupby $orderby $limits" );
         ...
         *
         * @param $meta_to_hide array Array of order_item_meta meta_key to hide
         *
         * @return array New array of order item meta to hide
         * @since  1.0
         * @author Antonio La Rocca <antonio.larocca@yithemes.it>
         */
        public function hide_order_item_meta( $meta_to_hide ) {
            $meta_to_hide = array_merge( $meta_to_hide, array(
                '_commission_id'
            ) );
